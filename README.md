...
| **Image Overlay** (`/tools/image-overlay`) | Drag/resize/rotate overlays onto a base photo; per-layer + base background removal, base brush touch-up, expanding canvas, trim-on-export — DOM edit + Canvas render. |
