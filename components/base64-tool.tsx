    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <textarea
          ...
          spellCheck={false}
          className="h-56 w-full resize-y rounded-xl border border-line bg-surface p-3 font-mono text-sm text-ink outline-none focus:border-accent"
        />
        <div className="relative">
          <textarea
            ...
            placeholder="Result"
            spellCheck={false}
            className={`h-56 w-full resize-y rounded-xl border bg-canvas p-3 font-mono text-sm text-ink outline-none ${
